...
command_list = discord.Embed(title="**__Command List__**", description="*Command's prefix : &*", color=0x00ff00)
  ...
  async def on_message(self, message):
    ...
    if message.content[0] == prefix:
      ...
      if args[0] == prefix + "about":
        await message.channel.send("> KanjiToKana is a bot created in order to help people that wants to learn Japanese. It has been created by Eindall#2121, feel free to add me if you have any question or would like to submit a feature request")
